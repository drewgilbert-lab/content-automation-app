...
| CL | Content Library | Phase 1 Done; Phases 2-6 Pending | [group-cl.md](./group-cl.md) |
...
| Content Library | Group CL — Phase 1 done (CL1–CL4): schema migration, type definitions, CRUD lib, tests. Phase 2–6 pending: internal API routes, UI pages, editorial workflow UI, dashboard integration, comprehensive testing, documentation. Unblocks Group K Phase 3 (K13–K16) and Group J Phase 7 (J26–J28) | See [Group CL](./group-cl.md) |
