...
| CL | Content Library | Phase 1-2 Done; Phases 3-6 Pending | [group-cl.md](./group-cl.md) |
...
| Content Library | Group CL — Phase 1-2 done (CL1–CL7): schema migration, types, CRUD lib, internal API routes (CRUD + workflow), tests. Phase 3–6 pending: UI pages, editorial workflow UI, dashboard integration, comprehensive testing, documentation. Unblocks Group K Phase 3 (K13–K16) and Group J Phase 7 (J26–J28) | See [Group CL](./group-cl.md) |
