...
| CL | Content Library | Phase 1-3 Done (CL1–CL12); Phases 4-6 Pending | [group-cl.md](./group-cl.md) |
...
| Content Library | Group CL — Phase 1-3 done (CL1–CL12): schema migration, types, CRUD lib, internal API routes (CRUD + workflow), tests, Content Library UI (list, detail, create/edit pages, navigation). Phase 4–6 pending: editorial workflow UI refinements, dashboard integration, comprehensive testing, documentation. Unblocks Group K Phase 3 (K13–K16) and Group J Phase 7 (J26–J28) | See [Group CL](./group-cl.md) |
