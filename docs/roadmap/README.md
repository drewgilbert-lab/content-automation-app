...
| W | Authentication & User Management | W1–W4 Done (Phase 1) | [group-w.md](./group-w.md) |
...
| Authentication & User Management | Group W Phase 1 done (W1–W4): Google OAuth sign-in, JWT sessions, domain restriction, User collection, middleware route protection, requireAuth/requireRole helpers, UserMenu, sign-in page. Phase 2 pending (W5–W7): RBAC enforcement, admin user management UI, user attribution. Phase 3 pending (W8–W9): custom permission sets, audit log | See [Group W](./group-w.md) |
